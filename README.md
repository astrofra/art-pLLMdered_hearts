...
pLLMdered Hearts is an installation first shown at _Matricule Bis Festival_ (organized by the [Orléans School of Art and Design](https://esadorleans.fr/)) that automatically plays [*Plundered Hearts*](https://en.wikipedia.org/wiki/Plundered_Hearts) (Infocom, 1987) while displaying an inner voice generated by an LLM. In parallel, a video viewer streams excerpts from Amy Briggs’ interview, selected based on embedding similarity with the LLM’s commentary.
